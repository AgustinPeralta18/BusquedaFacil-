...
<body>
  ...
  <section class="w-50 mx-auto text-center pt-5" id="intro">
    <h1 class="p-3 fs-2 border-top border-bottom border-dark border-3">La mejor página para tus <span class="text-bg-dark">descargas</span></h1>
      ...
      <div class="wrapper">
        ...
        <section class="d-flex" id="numeros-local">
          <div>
            ...
            <p class="text-danger fs-5">Año:</p>
            <p>Segundo</p>

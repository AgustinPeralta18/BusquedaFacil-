        ...
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                Mi nombre es: <strong>Agustin Peralta</strong>, tengo 20 años, estudio en la Universidad del Aconcagua y estoy cursando 2do año. Me gusta mucho el back-end y todo lo que viene siendo con la "parte
                de atras" de un programa. Fui al Liceo Militar General Espejo y me egresé en 2019.
                En <strong>2020</strong> en medio de la pandemia todavía no sabia que estudiar, un amigo me recomendó este "mundo", me encantó, desde 2020 que estoy programando y aprendiendo. <br>
                No fué nada facil entender la lógica de la programación en sí pero con el tiempo fui entendiendo hasta el día de hoy.
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
            <div class="accordion-body">
              <strong>Busqueda Facil</strong> Es una página donde se puede buscar de todo, desde IDES hasta juegos. <br>
              En esta página se utiliza en su mayoría <strong>Bootstrap</strong>.
            </div>
          </div>
        </div>
        <div class="accordion-item">

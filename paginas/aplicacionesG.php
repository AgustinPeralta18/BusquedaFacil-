      ...
      <tr>
        <th scope="col">
          ...
          <p class="parrafo-ides"><img src="../recursos/discordicon.jpg" class="image-aplicacionesG" alt="..."><br>
            Discord es un servicio de mensajería instantánea freeware de chat de voz VolP, video y chat por texto.
            Funciona a través de servidores y está separado en canales
      ...
      <tr>
        <th scope="col">
          ...
          <p class="parrafo-ides"><img src="../recursos/steamlogo.jpg" class="image-aplicacionesG" alt="..."><br>
            ...
            de proveer actualizaciones automáticas a sus juegos, pero finalmente se amplió para incluir juegos de
            terceros.
          </p>
        </th>
      ...
      <tr>
        <th scope="row">
          ...
          <p class="parrafo-ides"><img src="../recursos/spotifylogo.webp" class="image-aplicacionesG" alt="..."><br>
            Spotify es una empresa de servicios multimedia sueca fundada en 2006, cuyo producto es la aplicación
      ...
      <tr>
        <th scope="col">
          ...
          <p class="parrafo-ides"><img src="../recursos/originlogo.png" class="image-aplicacionesG" alt="..."><br>
            Origin es una plataforma de distribución digital desarrollada por Electronic Arts para comprar y jugar a
            videojuegos distribuidos o desarrollados por dicha compañía.
